return {
	double = {
		...
		advance = {"ulong", "long"},
		conv = {
			["float"] = {fmt="{3} = load float, float* {1}, align 4\n{2} = fpext float {3} to double\n", weight=0},
			["ulong"] = {fmt="{3} = load i64, i64* {1}, align 8\n{2} = uitofp i64 {3} to double\n", weight=0},
			["long"] = {fmt="{3} = load i64, i64* {1}, align 8\n{2} = sitofp i64 {3} to double\n", weight=0},
			["uint"] = {fmt="{3} = load i32, i32* {1}, align 4\n{2} = uitofp i32 {3} to double\n", weight=0},
			["int"] = {fmt="{3} = load i32, i32* {1}, align 4\n{2} = sitofp i32 {3} to double\n", weight=0},
			["ushort"] = {fmt="{3} = load i16, i16* {1}, align 2\n{2} = uitofp i16 {3} to double\n", weight=0},
			["short"] = {fmt="{3} = load i16, i16* {1}, align 2\n{2} = sitofp i16 {3} to double\n", weight=0},
			["byte"] = {fmt="{3} = load i8, i8* {1}, align 1\n{2} = uitofp i8 {3} to double\n", weight=0},
			["bool"] = {fmt="{3} = load i8, i8* {1}, align 1\n{4} = trunc i8 {3} to i1\n{5} = zext i1 {4} to i32\n{2} = sitofp i32 {5} to double\n", weight=0}},
		unop = {
			["-"] = "{2} = fneg double {1}\n"},
		binop = {
			["+"] = "{3} = fadd double {1}, {2}\n",
	...
	float = {
		...
		conv = {
			["double"] = {fmt="{3} = load double, double* {1}, align 8\n{2} = fptrunc double {3} to float\n", weight=0.1},
	...
	ulong = {
		...
		conv = {
			...
			["long"] = {fmt="{2} = load i64, i64* {1} align 8\n", weight=0.1},
			["uint"] = {fmt="{3} = load i32, i32* {1}, align 4\n{2} = zext i32 {3} to i64\n", weight=0},
			["int"] = {fmt="{3} = load i32, i32* {1}, align 4\n{2} = sext i32 {3} to i64\n", weight=0.1},
			["ushort"] = {fmt="{3} = load i16, i16* {1}, align 2\n{2} = zext i16 {3} to i64\n", weight=0},
			["short"] = {fmt="{3} = load i16, i16* {1}, align 2\n{2} = sext i16 {3} to i64\n", weight=0.1},
			["byte"] = {fmt="{3} = load i8, i8* {1}, align 1\n{2} = zext i8 {3} to i64\n", weight=0},
			["bool"] = {fmt="{3} = load i1, i1* {1}, align 1\n{2} = zext i1 {3} to i64\n", weight=0}},
		unop = {
			["!"] = "{2} = xor i64 {1}, -1\n"},
		binop = {
			["+"] = "{3} = add nuw i64 {1}, {2}\n",
	...
	long = {
		...
		conv = {
			...
			["ulong"] = {fmt="{2} = load i64, i64* {1} align 8\n", weight=0.1},
			["uint"] = {fmt="{3} = load i32, i32* {1}, align 4\n{2} = zext i32 {3} to i64\n", weight=0.1},
			["int"] = {fmt="{3} = load i32, i32* {1}, align 4\n{2} = sext i32 {3} to i64\n", weight=0},
			["ushort"] = {fmt="{3} = load i16, i16* {1}, align 2\n{2} = zext i16 {3} to i64\n", weight=0.1},
			["short"] = {fmt="{3} = load i16, i16* {1}, align 2\n{2} = sext i16 {3} to i64\n", weight=0},
	...
	uint = {
		...
		conv = {
			...
			["long"] = {fmt="{3} = load i64, i64* {1}, align 8\n{2} = trunc i64 {3} to i32\n", weight=0.2},
			["int"] = {fmt="{2} = load i32, i32* {1} align 4\n", weight=0.1},
			["ushort"] = {fmt="{3} = load i16, i16* {1}, align 2\n{2} = zext i16 {3} to i32\n", weight=0},
			["short"] = {fmt="{3} = load i16, i16* {1}, align 2\n{2} = sext i16 {3} to i32\n", weight=0.1},
			["byte"] = {fmt="{3} = load i8, i8* {1}, align 1\n{2} = zext i8 {3} to i32\n", weight=0},
			["bool"] = {fmt="{3} = load i1, i1* {1}, align 1\n{2} = zext i1 {3} to i32\n", weight=0}},
	...
	int = {
		...
		conv = {
			...
			["ulong"] = {fmt="{3} = load i64, i64* {1}, align 8\n{2} = trunc i64 {3} to i32\n", weight=0.2},
			["long"] = {fmt="{3} = load i64, i64* {1}, align 8\n{2} = trunc i64 {3} to i32\n", weight=0.1},
			["uint"] = {fmt="{2} = load i32, i32* {1} align 4\n", weight=0.1},
			["ushort"] = {fmt="{3} = load i16, i16* {1}, align 2\n{2} = zext i16 {3} to i32\n", weight=0.1},
			["short"] = {fmt="{3} = load i16, i16* {1}, align 2\n{2} = sext i16 {3} to i32\n", weight=0},
			["byte"] = {fmt="{3} = load i8, i8* {1}, align 1\n{2} = zext i8 {3} to i32\n", weight=0.1},
			["bool"] = {fmt="{3} = load i1, i1* {1}, align 1\n{2} = zext i1 {3} to i32\n", weight=0}},
	...
	ushort = {
		...
		conv = {
			...
			["int"] = {fmt="{3} = load i32, i32* {1}, align 4\n{2} = trunc i32 {3} to i16\n", weight=0.2},
			["short"] = {fmt="{2} = load i16, i16* {1} align 2\n", weight=0.1},
			["byte"] = {fmt="{3} = load i8, i8* {1}, align 1\n{2} = zext i8 {3} to i16\n", weight=0},
			["bool"] = {fmt="{3} = load i1, i1* {1}, align 1\n{2} = zext i1 {3} to i16\n", weight=0}},
		unop = {
			["!"] = "{2} = xor i16 {1}, -1\n"},
	...
	short = {
		...
		conv = {
			...
			["uint"] = {fmt="{3} = load i32, i32* {1}, align 4\n{2} = trunc i32 {3} to i16\n", weight=0.2},
			["int"] = {fmt="{3} = load i32, i32* {1}, align 4\n{2} = trunc i32 {3} to i16\n", weight=0.1},
			["ushort"] = {fmt="{2} = load i16, i16* {1} align 2\n", weight=0.1},
			["byte"] = {fmt="{3} = load i8, i8* {1}, align 1\n{2} = zext i8 {3} to i16\n", weight=0.1},
			["bool"] = {fmt="{3} = load i1, i1* {1}, align 1\n{2} = zext i1 {3} to i16\n", weight=0}},
		unop = {
			["-"] = "{2} = sub i16 0, {1}\n"},
