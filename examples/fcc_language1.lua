return {
	double = {
		...
		class = "fp",
		maxvalue = "1.8e+308",
		store = "store double {inp}, double* {adr}, align 8",
	...
	float = {
		...
		store = "store float {inp}, float* {adr}, align 4",
	...
	ulong = {
		...
		store = "store i64 {inp}, i64* {adr}, align 8",
	...
	uint = {
		...
		class = "unsigned",
		maxvalue = "4294967296",
		store = "store i32 {inp}, i32* {adr}, align 4",
	...
	ushort = {
		...
		class = "unsigned",
		maxvalue = "65536",
		store = "store i16 {inp}, i16* {adr}, align 2",
	...
	byte = {
		...
		class = "unsigned",
		maxvalue = "256",
		store = "store i8 {inp}, i8* {adr}, align 1",
