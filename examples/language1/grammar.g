...
constructordefinition	= linkage "constructor" callablebody						(constructordef)
			...
			;
operatordefinition      = linkage "operator" "->" typespec callablebody					(operatordef {name="->",minarg=0,maxarg=0})
			| linkage "operator" "=" typespec callablebody					(operatordef {name="=",minarg=0,maxarg=0})
			| linkage "operator" "+" typespec callablebody					(operatordef {name="+",minarg=0,maxarg=0})
			| linkage "operator" "-" typespec callablebody					(operatordef {name="-",minarg=0,maxarg=0})
			| linkage "operator" "*" typespec callablebody					(operatordef {name="*",minarg=0,maxarg=0})
			| linkage "operator" "/" typespec callablebody					(operatordef {name="/",minarg=0,maxarg=0})
			...
			| linkage "operator" "~" typespec callablebody					(operatordef {name="~",minarg=0,maxarg=0})
			| linkage "operator" "!" typespec callablebody					(operatordef {name="!",minarg=0,maxarg=0})
			| linkage "operator" "(" ")" typespec callablebody				(operatordef {name="()",minarg=0,maxarg=1024})
			| linkage "operator" "[" "]" typespec callablebody				(operatordef {name="[]",minarg=0,maxarg=1024})
			| linkage "operator" "==" typespec callablebody					(operatordef {name="==",minarg=1,maxarg=1})
			| linkage "operator" "!=" typespec callablebody					(operatordef {name="!=",minarg=1,maxarg=1})
			| linkage "operator" ">=" typespec callablebody					(operatordef {name=">=",minarg=1,maxarg=1})
			| linkage "operator" "<=" typespec callablebody					(operatordef {name="<=",minarg=1,maxarg=1})
			| linkage "operator" ">" typespec callablebody					(operatordef {name=">",minarg=1,maxarg=1})
