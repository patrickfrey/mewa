...
The installation description is written for Ubuntu. For other platforms you might need to lookup the corresponding package names.
...
```
#### Lua Environment
Don't forget to set the Lua environment (LUA_CPATH,LUA_PATH) correctly when running the Lua scripts from command line. 
