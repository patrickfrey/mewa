# Mewa
_Mewa_ is a compiler compiler for rapid prototyping. You write the grammar in a custom language, a sort of _Bison/Yacc_-style BNF with callbacks to a module written in Lua.
